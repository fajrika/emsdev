                        ...
                        <div class="col-md-12 col-sm-12 col-xs-12">
                            <div class="x_panel">
                                ...
                                <div class="x_content">
                                    ...
                                    <button type="button" id="btn-show-kwitansi" class="btn btn-primary col-md-2 col-md-offset-1">Kwitansi</button>
                                ...
                                <div class="x_content">
                                    ...
                                    <?php endif; ?>
                                    <button type="button" id="btn-history-kwitansi" class="btn btn-primary col-md-2 col-md-offset-1">History Kwitansi</button>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-12 col-sm-12 col-xs-12">
                                    ...
                                    if (tipe == 1) {
                                        $.ajax({
                                            ...
                                            success: function(data) {
                                                ...
                                                $("#read_more_unit").html("<button onc /edit?id=" + id + "','<?= site_url() ?>/P_master_unit/edit?id=" + id + "','Informasi Unit')\" class=\"btn btn-primary col-md-12\">Read More</button>");
