...
class P_tvi_aktifasi extends CI_Controller
{
    public function __construct()
    {
        ...
        $this->load->model('transaksi_lain/m_tvi_aktifasi');
    ...
    {
        $registrasis = $this->m_tvi_aktifasi->get();
        ...
        $this->load->view('proyek/transaksi_lain/tvi_aktifasi/view', [
    ...
    public function action(){
        ...
        // echo("</pre>");
        // die;
        $status = $this->m_tvi_aktifasi->action($this->input->get("id"),$this->input->get("status"));
        if ($status)       
            $this->session->set_flashdata('success','Data berhasil di simpan');
        else                        
            $this->session->set_flashdata('danger','Data sudah ada');
        redirect('transaksi_lain/P_tvi_aktifasi');
