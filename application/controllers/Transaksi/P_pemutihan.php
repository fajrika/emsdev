...
class P_pemutihan extends CI_Controller
{
	...
	public function ajax_get_unit_backup()//salah karena pakai v_salesforce_bill
	{
	...
	{
		echo json_encode($this->m_pemutihan->get_unit_test($this->input->get('blok'), $this->input->get('kawasan'), $this->input->get('periode_awal'), $this->input->get('periode_akhir'), $this->input->get("metode_tagihan[]")));
	}
