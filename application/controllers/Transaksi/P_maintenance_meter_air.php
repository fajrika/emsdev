...
class P_maintenance_meter_air extends CI_Controller 
{
	...
	public function index()
	{
		...
		$this->load->view('core/body_header', ['title' => 'Transaksi Service > Maintenance Meter Air','subTitle' => 'List']);
		$this->load->view('proyek/transaksi/maintenance_meter_air/view');
