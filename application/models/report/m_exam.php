...
class m_history_pembayaran extends CI_Model
{
        ...
        public function getCaraPembayaran()
        {
                ...
                $query = $this->db
                        ...
                        ->join(
                                "project",
                                "project.id = cara_pembayaran.project_id",
                                "LEFT"
                        )
        ...
        public function getAll($kawasan, $blok, $periode_awal, $periode_akhir, $cara_bayar, $jns_service)
        {
                ...
                $data = (object)[];
                $data->header = [
                        "Kode Kawasan", "Kode Blok", "No Unit", "No. Kwitansi", "Periode", "Pakai (m3)", "Tanggal Bayar", "Nilai Admin", "Denda",
                ...
                $data = (object)[];
                $data->header = [
                        "Kode Kawasan", "Kode Blok", "No Unit", "No. Kwitansi", "Periode", "Tanggal Bayar", "Denda",
