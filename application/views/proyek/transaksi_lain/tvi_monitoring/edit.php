...
<div style="float:right">
	<h2>
		<button class="btn btn-warning" onclick="location.href='<?=site_url(); ?>/p_tvi_aktifasi';">
			<i class="fa fa-arrow-left"></i>
			Back
		</button>
		<button class="btn btn-success" onClick="window.location.href='<?=site_url()?>/transaksi_lain/p_tvi_aktifasi/edit?id=<?=$this->input->get('id')?>'">
...
<div class="x_content">
	<br>
	<form id="form" data-parsley-validate="" class="form-horizontal form-label-left" novalidate="" method="post" action="<?=site_url(); ?>/transaksi_lain/p_tvi_aktifasi/edit?id=<?=$this->input->get('id'); ?>">
...
<script type="text/javascript">
	...
	$("#pilih_unit").change(function () {
...

		{
			...
			url = '<?=site_url(); ?>/transaksi_lain/p_tvi_aktifasi/lihat_unit';
			var pilih_unit = $("#pilih_unit").val();
	...
	$("#customer_name2").change(function () {
		...
		url = '<?=site_url(); ?>/transaksi_lain/p_tvi_aktifasi/lihat_customer';
