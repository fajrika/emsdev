...
<div style="float:right">
    <h2>
        <button class="btn btn-primary" onClick="window.location.href='<?= site_url() ?>/transaksi_lain/p_tvi_aktifasi'">
            <i class="fa fa-arrow-left"></i>
            Back
        </button>
        <button class="btn btn-success" onClick="window.location.href='<?= site_url() ?>/transaksi_lain/p_tvi_aktifasi/add'">
...
<div class="x_content">
    <form id="form" data-parsley-validate="" enctype="multipart/form-data" class="form-horizontal form-label-left" novalidate="" method="post" action="<?= site_url() ?>/transaksi_lain/p_tvi_aktifasi/save">
    ...
    $(function() {
        ...
        $("#unit_id").select2({
            ...
            ajax: {
                type: "GET",
                dataType: "json",
                url: "<?= site_url("transaksi_lain/p_tvi_aktifasi/get_ajax_unit") ?>",
        ...
        $("#unit_id").change(function() {
            $.ajax({
                ...
                url: "<?= site_url("transaksi_lain/p_tvi_aktifasi/get_ajax_unit_detail") ?>",
                dataType: "json",
        ...
        $("#paket_id").select2({
            ...
            ajax: {
                type: "GET",
                dataType: "json",
                url: "<?= site_url("transaksi_lain/p_tvi_aktifasi/get_ajax_paket") ?>",
                data: function(params) {
                    return {
                        data: params.term
                    }
        ...
        $("#paket_id").change(function() {
            $.ajax({
                ...
                url: "<?= site_url("transaksi_lain/p_tvi_aktifasi/get_ajax_paket_detail") ?>",
                dataType: "json",
				success: function(data) {
