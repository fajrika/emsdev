    ...
    <form id="form" class="form-horizontal form-label-left">
        <div class="com-lg-6 col-md-6 col-xs-6">
            ...
            <div class="form-group">
                ...
                <div class="col-md-9 col-sm-9 col-xs-12">
                    <input type="text" class="form-control" required name="username" placeholder="Masukkan Username (username harus sama dengan CES)" value="<?=$data->username?>">
                </div>
            </div>
            <div class="form-group">
        ...
        <div class="com-lg-6 col-md-6 col-xs-6">
            <div class="form-group">
                ...
                <div class="col-md-9 col-sm-9 col-xs-12">
                    <input type="number" class="form-control" placeholder="Masukkan Ces Id" name="ces_id" value="<?=$data->ces_id?>">
                </div>
            </div>
            <div class="form-group">
                <label class="control-label col-md-3 col-sm-3 col-xs-12">Email</label>
                <div class="col-md-9 col-sm-9 col-xs-12">
                    <input type="text" class="form-control" placeholder="Masukkan Email" name="email" value="<?=$data->email?>">
                </div>
            </div>
            <div class="form-group">
        ...
        $(function() {
            ...
            $("#submit").click(function(){
                $.ajax({
                    type: "GET",
                    data: $("#form").serialize(),
                    url: "<?= site_url() ?>/Setting/Akun/user/ajax_edit?id=<?=$data->id?>",
                    dataType: "json",
